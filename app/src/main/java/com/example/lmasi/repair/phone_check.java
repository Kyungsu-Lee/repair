 ...
 */
public class phone_check extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable[8] = getResources().getDrawable(R.drawable.asd);
        imgV[8].setBackground(drawable[8]);
        params[8] = new RelativeLayout.LayoutParams(1199, 1918);
        params[8].setMargins(123, 312, 0, 0);
